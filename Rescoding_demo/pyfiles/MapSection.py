...
class MapSection:
    ...
    def load_imgs(self):
        ...
        self.sad_face_tl = pygame.transform.scale(
                            pygame.image.load(MapSection.FOLDER_NAME+"/sadface_tl.png"), (75,75))
        self.sad_face_tr = pygame.transform.scale(
                            pygame.image.load(MapSection.FOLDER_NAME+"/sadface_tr.png"), (75,75))
        self.sad_face_bl = pygame.transform.scale(
                            pygame.image.load(MapSection.FOLDER_NAME+"/sadface_bl.png"), (75,75))
        self.sad_face_br = pygame.transform.scale(
                            pygame.image.load(MapSection.FOLDER_NAME+"/sadface_br.png"), (75,75))
