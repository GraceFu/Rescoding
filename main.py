...
def gamePage():
    ...
    text_if = font.render("if", False, BLACK)      # format text
    ...
    SCREEN.blit(text_if, (800 + 150 // 4, 20 + 40 // 4)) #print surface
...
def main():
    ...
    while run:
        ...
        if click == 1 and click_time == 0: # if first click it
            click_time += 1
            if 620 < mx < 770: #decide which sequential block the mouse is in
                if 20 < my < 60:
                    color = PINK
                elif 80 < my < 120:
                    color = MINT
                ...
                color = BLUE
        elif click == 1 and click_time == 1:  # if second time click it
            click_time += 1
            mx, my = pygame.mouse.get_pos()
            #cont = False
            #break
